...
- {{< iconify fa6-solid flag-checkered size=18px >}} **Thursday**: Executable Examination
  - *Demonstrate technical skills in software engineering*:
    ...
    - Debug defective Python functions
    - Confirm output of Python functions
    - **Exam Code A**: Thursday, December 14, 2023 at 9:00 AM
- {{< iconify fa-regular sad-tear size=19px >}} **Friday**: No class

::: {.callout-note appearance="minimal" title="Assessment Reminder" collapse="false"}

The final executable examination is cumulative in regards to all of the
technical, professional, and project content previously covered between week
one and week sixteen.
