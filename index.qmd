...
College](https://allegheny.edu/), the resources and projects are all publicly
...
there many benefits to being a proactive programmer? *Yes*! With that said, the
participants of this sixteen-week course will contain valuable perspectives and
...
Interested in getting started on a developer development adventure? Start here:

- [Sixteen-week course schedule](./schedule/index.qmd) offers detailed insights
  into each step that learners will take as the develop as developers, including
  a list of reading assignment and references to projects.
