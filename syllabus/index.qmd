...
write an executive summary, that should contain, at minimum, these components:
  ...
  explains the changes made to the technical and professional content content.
  Importantly, each of the discussion leaders for each executive summary should
  ensure that all commit messages adhere to the [conventional
