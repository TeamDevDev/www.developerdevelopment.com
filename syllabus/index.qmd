...
- **Week One**: Install development tools
...
- **Week Six**: No reading assignment

#### Module Two Reading Assignments

- **Week Seven**: Fall break and research conference travel
- **Week Eight**: Project development meetings and project demonstrations
- **Week Nine**: SE5 (Engineering for Equity and Documentation) and FB5 (Mutation-Based Fuzzing) and DB1 (Debugging)
