...
How are resources such as time or storage impacted by our decisions? It is
important to come up with low cost solutions that still get the job done.

#### Constraints

The 4th principle which isn't mentioned in the book but in the podcast is
"constraints".
...
While developing Gatorgrade we will have to keep on mind these principles. First
of all the trade-offs our decisions are super important because certain
functions may cost a lot of time or computer storage so making decisions that
are low-cost but are also practical is important. Ask ourselves is there a way
to improve this code either worst-case time complexity wise or by choosing
better object types to suit the task at hand. 
...
code? If the CIS department at Allegheny College grows by 1000 students are we
