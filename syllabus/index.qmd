...
- **SE-4**: Can effectively create and use software engineering tools that
...
- *Course Activities*:
  - **Technical Development**: Develops **SE-1**, **SE-2**, and **SE-4**
  - **Professional Development**: Develops **SE-3** and **SE-5**
  - **Project Development**: Develops **SE-1** through **SE-5**
- *Course Assessments*:
  - **Executable Examinations**: Assesses **SE-1**, **SE-2**, and **SE-4**
  - **In-Person Assessments**: Assesses **SE-3**, **SE-4**, and **SE-5**
...
- **AC-1** is attained through the course learning objectives **SE-1**, **SE-2**, and **SE-4**
- **AC-2** is attained through the course learning objectives **SE-3** and **SE-5**
- **AC-3** is attained through the course learning objectives **SE-2** and **SE-5**
- **AC-4** is attained through the course learning objectives **SE-1**, **SE-3**
