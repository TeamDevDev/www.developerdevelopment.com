...
There are many strategies that different companies have employed when it comes to code review, from "gatekeeping" to having certain teams responsible for different aspects of the process. Beyond these, this chapter considers the many benefits of code review from debugging to knowledge sharing. There are even psychological benefits discussed. 
