...
The Fuzzing Book has a chapter that talks about something called mutation analysis. This is a way to check how good our tests are when we run software. Just because we test a lot doesn't mean the software will always work right. The book gives two examples, named ineffective_test_1 and ineffective_test_2, to show this point.
...
The chapter also mentions problems when we purposely add fake errors to test the program. This reminds us to be careful and make sure our tests are both thorough and able to find real mistakes in the software.
