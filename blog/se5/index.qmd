...
focus to take into consideration. These are outlined in the **Value Versus
Outcomes** section, as summarised and paraphrased below.
...
2. Assume everyone will use it, and use this to take into account the one that
   ...
   order to ensure that accessibility is built in.
...
instead of being part of the problem in order to ensure equity.
