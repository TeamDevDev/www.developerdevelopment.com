...
for a better implementation. Let's dive into the details!
...
which are a form of visualization for the steps of a grammar. Below is an
example of a tree built from the expression `2 + 2`.
