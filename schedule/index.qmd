...
- **Friday**: Development Development
...
- **Monday**: Write a personal précis and publish the team's executive summary:
  - **SE1**: Preface - Programming Over Time
- **Tuesday**: Demonstrate installation and use of the following artifacts:
  - [Chasten](https://github.com/AstuteSource/chasten): tool for analyzing Python abstract syntax trees
  - [Fuzzing Book (FB)](https://www.fuzzingbook.org/): tools and techniques for generating tests
  - [Debugging Book (DB)](https://www.debuggingbook.org/): tools and techniques for automated debugging
- **Wednesday**: Write a personal précis and publish the team's executive summary:
  - **FB1**: Introduction to Software Testing
- **Friday**: Publish final executive summaries to the Developer Development blog:
  - **SE1**: Preface - Programming Over Time
  - **FB1**: Introduction to Software Testing
