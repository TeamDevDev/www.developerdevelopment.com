...
- **Module One**: Introduction to Software Engineering
    ...
    - *Week Six*:
      ...
      - **Tuesday**: complete the first executable examination
...
- **Module Two**: Introduction to Software Engineering
    - **Week Seven**: Demonstrate the beta version of first software project

:::

::: {.callout-note appearance="minimal" title="Weekly Cadence" collapse="false"}
...
- {{< iconify fa-solid laptop-code size=18px >}} **Friday**: Technical preparation for joining a software startup
