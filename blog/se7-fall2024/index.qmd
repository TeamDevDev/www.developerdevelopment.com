...
at Google](https://abseil.io/resources/swe-book) book. In previous class
...
"Always Be Deciding" builds upon the concepts covered in "How to Lead a Team"
and how to elevate from an effective team member to an effective leader.
...
forms of how to use our resources, mainly the members of our course and their
time. A powerful quote from this section, from Ben Collins-Sussman is **"If
writing code is analogous to chopping down trees, your job as a leader is to see
the forest through the trees and find a workable path through that forest,
directing engineers toward the important trees".**
...
enter the compression phase where half the team works on the problem with half
