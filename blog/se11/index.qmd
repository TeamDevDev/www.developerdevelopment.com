...
* https://keller-liptrap.netlify.app/ Summary In this section of the software
  engineering at google book we are getting an overview in testing. Testing in
  software has been an important task even from the begining of coding and used
  to be a manuel step we had to take but now we can automate these tests. This
  allows software engineers to change and adapt code quickly. Althoough testing
  is used very often it is very hard to master. There are four bulltet points
  the author uses to desribe a simple test:
...
Google](https://abseil.io/resources/swe-book/html/toc.html) book.
