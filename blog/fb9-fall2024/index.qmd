...
would’ve given the output (2 * 3), and broke it by altering how the term would
expand, which is <term> : := <factor>. Therefore changing the grammatical rule
of how <term> would expand.
