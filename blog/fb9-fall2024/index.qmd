...
string. In the Fuzzing book it talks about two strategies, Replacing the
subtrees and Alternative Expansions.

# Replacing the Subtrees

Replacing the sub-tress means to take a larger part of the tree and replace it with a smaller part of the tree. In the example given it shows the original tree which makes up the string "1 + (2 * 3)" and then being broken down to "(2 * 3)" by replacing the upper most <expr> with the lowest <expr>.
