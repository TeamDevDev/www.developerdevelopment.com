...
professional development tasks have the following goals: (i) help a learner to
demonstrate that they can remember the learned material by recalling facts,
basic concepts, and answers to questions presented in **SE** and on the course
web site and (ii) allow a learner to demonstrate an understanding of facts and
ideas by translating, interpreting, and stating the main professional ideas
presented in **SE**.
...
- Publication of the professional précis to Netlify-hosted web site using
quarto.
