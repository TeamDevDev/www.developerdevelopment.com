...
This is our first blog post concerning the [Software Engineering at Google
book](https://abseil.io/resources/swe-book)! It contains three sections: the
summary, reflection, and action items. The goal of this post is to relate the
material from the book to our progress on our Chasten tool, with the hope that
it will provide valuable lessons on how we approach designing and developing our
own software.
