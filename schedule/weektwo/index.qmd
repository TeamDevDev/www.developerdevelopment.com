        ...
        - {{< iconify fa6-solid diagram-project size=18px>}} **Thursday**: Project Development
          ...
          - {{< iconify game-icons team-idea size=18px>}} **Friday**: Developer Development
            ...
            - *Confirm that all team members can use the following tools*:
              ...
              - Python and uv (make sure that Python installs through uv and is the latest version)
              - VSCode and Python programming tools
              - VSCode and the Quarto publishing tool
              - Node package manager and all JavaScript programming tools
              - Either the `OpenCode` or `Pi` coding agent running in a terminal window
              - Authorize your coding agent to use GitHub Copilot, OpenCode Zen, and/or OpenCode Go
