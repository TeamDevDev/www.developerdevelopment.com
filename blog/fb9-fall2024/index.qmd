...
reducers. Reduction helps us debug the failure so the instance where it
happens can be found. There are manual ways to do this but for long inputs a
way to automate it will help reducing be faster. 
