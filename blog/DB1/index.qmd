...
After reading and interpreting this article this article, we as programmers learn more about debugging.
We learn about how simple debugging is and how we can make it legibe with Python. Debugging means to simultaneously
find and fix problems within our code.  The author wants programmers to approach debugging by using the Scientific Method.

In the chapter, a Python function is used to represent how debugging would look. In the function there is a bug which causes
the function to not work properly. The article shows step by step whats wrong and how to debug this function. The message being
conveyed in this article is to simply use a systematic and methodical approach when going about debugging.

To conclude, the article talks about how to find and debug errors in different in different programs. It talks about how to go about
debugging in order to get the best results possible.
