...
wrench' in the collaborative process. Given that we are currently working to put
our team policies on [our website](https://www.developerdevelopment.com/), we
may see the issue regarding the lack of informed team members disappear in the
following weeks. Lastly, as long as we continue to meet together and read these
articles, the general technical literacy of each team member will
consequentially improve.

Considering the amount of time that this weekly process requires, we advocate to
halt our weekly review of these articles. Our primary focus is to *develop
software*. While we can still seek to improve our technical literacy and learn,
we have created a considerable overhead for ourselves. Doing away with this
weekly responsibility will mitigate problems such as this. Additionally, this
