...
points addressed in the previous section show us what must be done in order to
for the members of our team to have success and to accomplish the goal to finish
our projects by the end of the semester. Within each point it gives key insight
such as examples and other notes and goes in depth for what steps we should
take. 


An example is the cycle of success and the case study: Addressing
the "Latency" of Web Search. Both of these gave a clear insight of systems that
could be implemented in the team. This also gave more additionally from last
week's SE6 discussion about how to lead a team as that offered a base for the
SE7 discussion on leading at a scale. It adds on to the points given previously
and proceeds to give more advice that could be grasped for leading in our team.
...
While we currently operate without specific leaders, it might be beneficial to
introduce more formal leadership roles in the future. This will help ensure
alignment and direction, but it's also important that each team member has the
opportunity to lead at some point. After all, our group is not just a software
engineering team; it's a class, and leadership development is a key part of our
collective growth.
