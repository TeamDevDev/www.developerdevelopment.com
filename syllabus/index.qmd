...
- Perform these steps both when reading an article and writing an executive summary:
  ...
  - Discussion leads for a weekly reading assignment complete the following tasks:
    ...
    - Leadership team uses [GitHub Actions](https://docs.github.com/en/actions) and [Netlify](https://www.netlify.com/) to publish the Quarto-based web site
