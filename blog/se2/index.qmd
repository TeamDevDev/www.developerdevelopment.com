...
yourself with the longecity of the program you create and are working on and remember to
work as a **team** these are not single person projects. **Longevity** general upkeep and maintance
...
working on something for long periods of time that ultimely has minimal or no gain compared 
to the effort and time it took to implement. So making these decisions are crucial to ensuring
things get done **effectivly** and **efficiently**

As stated before it important to understant that these are not single person operation they
require people to communicate, be organized and be informed of the direction of the project.
If people aren't on the same page then you can have people doing redundant work, irrelevent work
or no work at all getting your project nowhere. Its important to **be critical** on the systems and
rules in place as they may need to change depending on the situation you cant be sucessful as a
team or organization without some forms of critisizm or adjustment so it important for people
to express there opinions and concerns.

## Reflection

While as a team we have made improvments in organization and communication theres still
a long way to go. As alot of people seem to not be on the same page and are still having
...
We need to take little more responsibility for eachother as we have not fully grasped
