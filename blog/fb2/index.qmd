...
following their improvements, and how to bring the coverage up to a more ideal
level through the generation of tests. Critically, if we do not have test cases
that cover source code for existing and new functionality and/or bug fixes in
[Chasten](https://github.com/AstuteSource/chasten) then we don't have a good way
to know whether or not these code segments are correct!
