...
This weeks chapter in the [Software Engineering at Google
book](https://abseil.io/resources/swe-book) focuses on teamwork. Working well in
teams results in better software being developed. This chapter focuses on
...
If we lost access to Professor Kapfhammer's laptop we would not be able to push
our work since we need his login to PyPI. This stresses the "Bus Factor" where
it would be better to have another place to push to. However, if you can push
from any computer, then people might start pushing when we are not ready to
actually deploy.
</details>
...
comments is very important so there does not become bigger problems. It is also
