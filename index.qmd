...
As the developing developers in the on-campus course read articles in the
**SE**, **FB**, and **DB** online textbooks, they will collaboratively write
and publish that summarizes and contextualizes the material and points towards
a way in the lessons from these books can be applied to two long-term software
development projects. These learners will also prototype and release simple
command-line tools that illustrate the key concepts and techniques that they
have learned from the three textbooks, ultimately demonstrating their
professional development, technical development, and overall development as a
software developer who works effectively in a team.
...
enhance their abilities as a software engineering while collaboratively building
and releasing two open-source tools. Ultimately, these challenges are worth it!
Computer and information science graduates, like [Aidan
Dyga](https://www.linkedin.com/in/aidandyga/), frequently report that the
software engineering course is the [most impactful one that they take at
Allegheny
College](https://allegheny.edu/about/news/curiosity-leads-to-career-outcomes/)
because it effectively emphasizes "communication skills and real-world project
management".
...
engineering. With accompanying links to useful software command-line tools, here
are the most recent posts that we have written!
