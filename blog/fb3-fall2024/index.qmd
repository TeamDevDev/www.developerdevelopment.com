...
## Reflection
Overall Fuzzing is a great way to check programs. By discovering bugs related to how a program handles inputs, fuzzers can be very useful when testing code. Fuzzers can detect many types of erros including buffer overflows, missing error checks, and the precense of rogue numbers. 
