...
- Using `uv`, install [Python 3.11, 3.12, 3.13, and
3.14](https://www.python.org/) on your development workstation
...
- Use [asdf-vm](https://asdf-vm.com/) or [mise](https://mise.jdx.dev/) to
...
- Practice all of tasks in the [GitHub
